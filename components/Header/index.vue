      ...
      <div class="container">
        <div class="sub-header">
          ...
          <nav class="sub-header--menu">
            <a class="sub-header--menu--item" href="#">宜家卡</a>
            <a class="sub-header--menu--item" href="#">IKEA 企業業務</a>
      ...
      <div class="container">
        <div class="main-header">
          ...
          <nav class="main-header--menu">
            ...
            <DropDownMenuItem class="main-header--menu--item" iconName="chevron-down" label="空間" />
            <a class="main-header--menu--item" href="#">佈置靈感</a>
            <a class="main-header--menu--item" href="#">再創低價</a>
            <a class="main-header--menu--item" href="#">新品專區</a>
          </nav>
        </div>
      </div>
    </div>
